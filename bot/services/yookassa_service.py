    ...
    async def create_payment(
        ...
        try:
            ...
            receipt_items_list: List[Dict[str, Any]] = [{
                ...
                "vat_code":
                str(settings.YOOKASSA_VAT_CODE),
                "payment_mode":
                getattr(settings, 'yk_receipt_payment_mode', settings.YOOKASSA_PAYMENT_MODE),
                "payment_subject":
                getattr(settings, 'yk_receipt_payment_subject', settings.YOOKASSA_PAYMENT_SUBJECT)
            }]
